...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initMaps.initMap)();
    (0, _initMaps.initMap2)();
    (0, _initMaps.initMap3)();
    (0, _initMaps.initMap4)();
...
},{"./modules/animation/init-animate-batch.js":2,"./modules/animation/init-animate-intro.js":3,"./modules/animation/init-sticky-slider.js":4,"./modules/form-validate/form":6,"./modules/init-loader":12,"./modules/init-main-nav":13,"./modules/initMaps.js":14,"./modules/input-file/init-upload":19,"./modules/modals/init-modals":22,"./modules/select/custom-select":25,"./utils/ios-vh-fix":28,"./utils/scroll-lock-ios":30,"./utils/scroll-lock.js":31}],2:[function(require,module,exports){
"use strict";
...
exports.initMap4 = exports.initMap3 = exports.initMap2 = exports.initMap = void 0;
var initMap = function initMap() {
  var container = document.querySelector('[data-map="map-1"]');
  if (!container) {
    return;
  }
...
var initMap2 = function initMap2() {
  var container = document.querySelector('[data-map="map-2"]');
  if (!container) {
    return;
  }
  var zoomValue = container.dataset.zoom;
  var centerValue = container.dataset.center.split(',');
  ymaps.ready(function () {
    var myMap2 = new ymaps.Map(container, {
      center: centerValue,
      zoom: zoomValue
    }, {
      searchControlProvider: 'yandex#search'
    ...
    var myPlacemark = new ymaps.Placemark(myMap2.getCenter(), {
      hintContent: 'Собственный значок метки'
      // balloonContent: 'Это красивая метка',
    }, {
      // Опции.
...
var initMap3 = function initMap3() {
  var container = document.querySelector('[data-map="map-3"]');
  if (!container) {
    return;
  }
  var zoomValue = container.dataset.zoom;
  ...
  ymaps.ready(function () {
    ...
    var message = document.querySelector('[data-map="superzoom"]');
...
var initMap4 = function initMap4() {
  var container = document.querySelector('[data-map="map-4"]');
  if (!container) {
    return;
  }
  ...
  ymaps.ready(function () {
    ...
    var listBoxItems = ['Школа', 'Аптека', 'Магазин', 'Больница', 'Бар'].map(function (title) {
    ...
    var reducer = function reducer(filters, filter) {
...
},{"./helper":18}],18:[function(require,module,exports){
"use strict";
...
},{"./upload.js":21}],20:[function(require,module,exports){
"use strict";
...
},{"./create-message-markup":15,"./create-preview-container-markup":16,"./create-preview-markup":17,"./render":20}],22:[function(require,module,exports){
"use strict";
...
},{"./modals":23}],23:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":26,"../../utils/scroll-lock":31}],24:[function(require,module,exports){
"use strict";
...
},{"../../utils/render":29,"./create-select-markup":24}],26:[function(require,module,exports){
"use strict";
